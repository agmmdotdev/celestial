    ...
    "app/WebhookService",
    {
        effect: Effect.gen(function* () {
            ...
            return {
                 ...
                 * ```
                 */
                getPageDetails: (pageId: string, pageAccessToken?: string): Effect.Effect<PageDetailsResponse, FacebookApiError> =>
                    Effect.gen(function* () {
                 ...
                 * ```
                 */
                getSubscribedApps: (pageId: string, pageAccessToken?: string): Effect.Effect<SubscribedAppsResponse, FacebookApiError> =>
                    Effect.gen(function* () {
                        const accessToken = pageAccessToken ?? (yield* envService.getUserAccessToken());
