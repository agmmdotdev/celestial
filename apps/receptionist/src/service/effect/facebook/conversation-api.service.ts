              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.REQUEST_BODY_CREATION_FAILED,
                ...
                Effect.catchAll((error) =>
                  Effect.fail(
                    new FacebookApiError({
                      code: 0,
                      message:
                        ConversationApiErrorMessage.PASS_THREAD_CONTROL_FAILED,
                      details: toFacebookErrorDetail(error),
                    })
                  )
                )
              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.PARSE_PASS_THREAD_CONTROL_RESPONSE_FAILED,
                    details: toFacebookErrorDetail(error),
                  })
                )
              )
                ...
                Effect.catchAll((error) =>
                  Effect.fail(
                    new FacebookApiError({
                      code: 0,
                      message:
                        ConversationApiErrorMessage.TAKE_THREAD_CONTROL_FAILED,
                      details: toFacebookErrorDetail(error),
                    })
                  )
                )
              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.PARSE_TAKE_THREAD_CONTROL_RESPONSE_FAILED,
                    details: toFacebookErrorDetail(error),
                  })
                )
              )
                ...
                Effect.catchAll((error) =>
                  Effect.fail(
                    new FacebookApiError({
                      code: 0,
                      message:
                        ConversationApiErrorMessage.REQUEST_THREAD_CONTROL_FAILED,
                      details: toFacebookErrorDetail(error),
                    })
                  )
                )
              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.PARSE_REQUEST_THREAD_CONTROL_RESPONSE_FAILED,
                    details: toFacebookErrorDetail(error),
                  })
                )
              )
              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.GET_THREAD_OWNER_FAILED,
                    details: toFacebookErrorDetail(error),
                  })
                )
              )
              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.PARSE_THREAD_OWNER_RESPONSE_FAILED,
                    details: toFacebookErrorDetail(error),
                  })
                )
              )
              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.GET_SECONDARY_RECEIVERS_FAILED,
                    details: toFacebookErrorDetail(error),
                  })
                )
              )
              ...
              Effect.catchAll((error) =>
                Effect.fail(
                  new FacebookApiError({
                    code: 0,
                    message:
                      ConversationApiErrorMessage.PARSE_SECONDARY_RECEIVERS_RESPONSE_FAILED,
                    details: toFacebookErrorDetail(error),
                  })
                )
              )
